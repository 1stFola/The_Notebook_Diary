...
public class DiaryExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler({NoteBookAppException.class})
    public ResponseEntity<Object> diaryApplicationExceptionHandler(NoteBookAppException exception, WebRequest request){
